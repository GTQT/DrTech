...
public class CropRegistry {
    ...
    public static void registerAll() {
        ...
        //  Tier 0: 杂草
        // ================================================================
        register(new CropType.Builder("weed").displayName("杂草").tier(0).soil(SoilRegistry.getAllSoils())
        ...
        register(new CropType.Builder("cyazint").displayName("蓝花").tier(2).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(18)
                .addDrop(new ItemStack(Items.DYE, 2, 4))
                .renderType(CropRenderType.FLOWER).build());

        register(new CropType.Builder("tulip").displayName("郁金香").tier(2).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(18)
        ...
        register(new CropType.Builder("xp_berry").displayName("经验莓").tier(2).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(18)
                .addDrop(new ItemStack(ItemsInit.ITEM_XP_BERRY))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("gel_grass").displayName("凝球草").tier(2).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(18)
        ...
        register(new CropType.Builder("flax").displayName("亚麻").tier(3).soil(SoilTypes.dirtGrass)
        ...
        register(new CropType.Builder("hyacinth").displayName("风信子").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(22)
                .addDrop(new ItemStack(Items.DYE, 2, 6))
                .renderType(CropRenderType.FLOWER).build());

        register(new CropType.Builder("leatherleaf").displayName("皮革叶").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(24)
                .addDrop(new ItemStack(Items.LEATHER, 2))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("milk_wart").displayName("牛奶疣").tier(3).soil(SoilTypes.mushroom)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(22)
                .addDrop(DrMetaItems.MILK_WART.getStackForm())
                .seedTexture("spore").seedColor(0xF8F8F8)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("egg_berry").displayName("鸡蛋莓").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(22)
                .addChanceDrop(new ItemStack(Items.EGG, 1), 0.4f)
                .addChanceDrop(new ItemStack(Items.FEATHER, 1), 0.4f)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("rubber_grass").displayName("橡胶草").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(22)
                .addDrop(DrMetaItems.XJC.getStackForm(4))
                .addChanceDrop(DrMetaItems.XJC.getStackForm(2), 0.3f)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("mercury_flower").displayName("水银花").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(24)
                .addDrop(CraftingRecipes.getItemStack("thaumcraft:shimmerleaf", 3L))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("hemp_stem").displayName("大麻茎").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(22)
                .addDrop(DrMetaItems.HEMP_STEM.getStackForm())
                .seedTexture("grains").seedColor(0x88AA44)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("papyrus").displayName("纸莎草").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(22)
                .addDrop(new ItemStack(Items.PAPER, 3))
                .waterRequirement(0.8f)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("meat_berry").displayName("肉芽莓").tier(3).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(24)
                ...
                .subSoil(SubSoilRequirements.fleshBlock)
                .renderType(CropRenderType.CROSS).build());

        // ================================================================
        //  Tier 4
        // ================================================================
        register(new CropType.Builder("stickreed").displayName("粘性甘蔗").tier(4).soil(SoilTypes.dirtGrass)
        ...
        register(new CropType.Builder("blackthorn").displayName("黑荆棘").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(25)
                .addDrop(new ItemStack(Items.DYE, 2, 0))
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("wonderflower").displayName("奇妙花").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                .addDrop(new ItemStack(Items.DYE, 2, 5))
                .renderType(CropRenderType.FLOWER).build());

        register(new CropType.Builder("rapeseed").displayName("油菜花").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(24)
                .addDrop(DrMetaItems.RAPESEED_FLOWER.getStackForm(3))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("snapdragon").displayName("金鱼草").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(24)
                .addDrop(DrMetaItems.SNAPDRAGON.getStackForm(3))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("fertilizer_grass").displayName("肥料草").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(24)
                .addDrop(new ItemStack(Items.DYE, 3, 15))
                .addChanceDrop(MetaItems.FERTILIZER.getStackForm(2), 0.2f)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("corpse_wart").displayName("尸骨瘤").tier(4).soil(SoilTypes.mushroom)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
        ...
        register(new CropType.Builder("spider_bite").displayName("蜘蛛咬").tier(4).soil(SoilTypes.mushroom)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                .addDrop(new ItemStack(Items.SPIDER_EYE, 1))
                .addDrop(new ItemStack(Items.STRING, 2))
                .lightRequirement(0).renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("fishing_rod_crop").displayName("钓鱼竿").tier(4).soil(SoilTypes.water)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                .lootTable("minecraft:gameplay/fishing")
                .waterRequirement(0.5f).renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("canola_flower").displayName("油菜花").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(24)
                .addDrop(DrMetaItems.CANOLA_FLOWER.getStackForm())
                .seedTexture("flower").seedColor(0xFFDD00)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("hops").displayName("啤酒花").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(24)
                .addDrop(DrMetaItems.HOPS.getStackForm())
                .seedTexture("flower").seedColor(0x88CC00)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("indigo_blossom").displayName("靛蓝花").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(24)
        ...
        // 神秘莓系列 (6种)
        {
            ...
            register(new CropType.Builder("mystical_order").displayName("秩序神秘莓").tier(4).soil(SoilTypes.dirtGrass)
                    .maxGrowthStage(5).harvestStage(5).stageRequirement(25)
                    .addDrop(ordo)
                    .renderType(CropRenderType.CROSS).build());
            register(new CropType.Builder("mystical_chaos").displayName("混沌神秘莓").tier(4).soil(SoilTypes.dirtGrass)
                    .maxGrowthStage(5).harvestStage(5).stageRequirement(25)
                    .addDrop(perditio)
                    .renderType(CropRenderType.CROSS).build());
            register(new CropType.Builder("mystical_wind").displayName("风神秘莓").tier(4).soil(SoilTypes.dirtGrass)
                    .maxGrowthStage(5).harvestStage(5).stageRequirement(25)
                    .addDrop(aer)
                    .renderType(CropRenderType.CROSS).build());
            register(new CropType.Builder("mystical_fire").displayName("火神秘莓").tier(4).soil(SoilTypes.dirtGrass)
                    .maxGrowthStage(5).harvestStage(5).stageRequirement(25)
                    .addDrop(ignis)
                    .renderType(CropRenderType.CROSS).build());
            register(new CropType.Builder("mystical_water").displayName("水神秘莓").tier(4).soil(SoilTypes.dirtGrass)
                    .maxGrowthStage(5).harvestStage(5).stageRequirement(25)
                    .addDrop(aqua)
                    .waterRequirement(0.3f).renderType(CropRenderType.CROSS).build());
            register(new CropType.Builder("mystical_earth").displayName("地神秘莓").tier(4).soil(SoilTypes.dirtGrass)
                    .maxGrowthStage(5).harvestStage(5).stageRequirement(25)
                    .addDrop(terra)
                    .renderType(CropRenderType.CROSS).build());
        }
        ...
        for (int i = 0; i < mysticColors.length; i++) {
            register(new CropType.Builder("mystic_flower_" + mysticColors[i][0])
                    ...
                    .soil(SoilTypes.dirtGrass)
                    .maxGrowthStage(4).harvestStage(4).stageRequirement(24)
                    .addDrop(CraftingRecipes.getItemStack("botania:petal", i))
                    .renderType(CropRenderType.FLOWER).build());
        }
        // 盆栽树变种
        register(new CropType.Builder("livingwood_bonsai").displayName("活木盆栽树").tier(4).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                .addDrop(CraftingRecipes.getItemStack("<botania:livingwood>"))
                .subSoil(SubSoilRequirements.livingwood)
                .renderType(CropRenderType.CROSS).build());
        register(new CropType.Builder("livingrock_bonsai").displayName("活石盆栽树").tier(4).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                .addDrop(CraftingRecipes.getItemStack("<botania:livingrock>"))
                .subSoil(SubSoilRequirements.livingrock)
                .renderType(CropRenderType.CROSS).build());
        // 石莲系列 (6色)
        register(new CropType.Builder("redstone_lotus").displayName("红石莲").tier(4).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                ...
                .subSoil(SubSoilRequirements.redGranite)
                .renderType(CropRenderType.CROSS).build());
        register(new CropType.Builder("white_lotus").displayName("白石莲").tier(4).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                ...
                .subSoil(SubSoilRequirements.marble)
                .renderType(CropRenderType.CROSS).build());
        register(new CropType.Builder("gray_lotus").displayName("灰石莲").tier(4).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                ...
                .subSoil(SubSoilRequirements.andesite)
                .renderType(CropRenderType.CROSS).build());
        register(new CropType.Builder("black_lotus_small").displayName("黑石莲").tier(4).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                ...
                .subSoil(SubSoilRequirements.blackGranite)
                .renderType(CropRenderType.CROSS).build());
        register(new CropType.Builder("yellow_lotus").displayName("黄石莲").tier(4).soil(SoilTypes.stone)
                .stageRequirement(26)
                .addChanceDrop(Materials.Endstone.getItemForm(OrePrefix.dust, 6), 0.5f)
                .addChanceDrop(new ItemStack(Blocks.SAND, 2), 0.5f)
                .subSoil(SubSoilRequirements.endStone)
                .renderType(CropRenderType.CROSS).build());
        register(new CropType.Builder("nether_lotus").displayName("下界石莲").tier(4).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(Materials.Netherrack.getItemForm(OrePrefix.dust, 6))
                .subSoil(SubSoilRequirements.netherrack)
                .lightRequirement(0)
                .renderType(CropRenderType.CROSS).build());
        ...
        //  Tier 5
        // ================================================================
        register(new CropType.Builder("ferru").displayName("铁叶草").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(new ItemStack(Items.IRON_NUGGET, 2))
                .subSoil(SubSoilRequirements.iron)
                .seedTexture("oreberry").seedColor(Materials.Iron.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("shining").displayName("闪光草").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(new ItemStack(Items.GLOWSTONE_DUST, 2))
                .subSoil(SubSoilRequirements.glowstone)
                .lightRequirement(12).renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("nether_wart_crop").displayName("地狱疣作物").tier(5).soil(SoilTypes.soulsand)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(28)
                .addDrop(new ItemStack(Items.NETHER_WART))
                .lightRequirement(0).renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("sweet_flower").displayName("甜蜜花").tier(5).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(26)
                .addDrop(new ItemStack(Items.SUGAR, 3))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("slimeplant").displayName("粘球草").tier(5).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(new ItemStack(Items.SLIME_BALL, 2))
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("carbon_wart").displayName("碳化疣").tier(5).soil(SoilTypes.netherrack)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(new ItemStack(Items.COAL, 2))
                .subSoil(SubSoilRequirements.coal)
                .lightRequirement(0).renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("oil_berry").displayName("石油浆果").tier(5).soil(SoilTypes.sand)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(DrMetaItems.OIL_BERRY.getStackForm())
                .addDrop(CraftingRecipes.getItemStack("<extrabees:propolis:1>", 4L))
                .subSoil(SubSoilRequirements.oilSands)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("corruption_wart").displayName("腐化瘤").tier(5).soil(SoilTypes.mushroom)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(CraftingRecipes.getItemStack("<thaumcraft:taint_fibre>"))
                .lightRequirement(0).renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("lead_leaf").displayName("铅叶子").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(Materials.Lead.getItemForm(OrePrefix.nugget, 2))
                .subSoil(SubSoilRequirements.lead)
                .seedTexture("oreberry").seedColor(Materials.Lead.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("salt_root").displayName("盐根").tier(5).soil(SoilTypes.sand)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
        ...
        register(new CropType.Builder("mica_grass").displayName("云母草").tier(5).soil(SoilTypes.sand)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(Materials.Mica.getItemForm(OrePrefix.dust, 3))
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("ascend_berry").displayName("飞升莓").tier(5).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(new ItemStack(ItemsInit.ITEM_SOAR_XP_BERRY))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("arid_lotus").displayName("干旱莲").tier(5).soil(SoilTypes.sand)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
        ...
        register(new CropType.Builder("argentia_leaf").displayName("银叶草").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(DrMetaItems.ARGENTIA_LEAF.getStackForm())
                .subSoil(SubSoilRequirements.silver)
                .seedTexture("oreberry").seedColor(Materials.Silver.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("auronia_leaf").displayName("金叶草").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(DrMetaItems.AURONIA_LEAF.getStackForm())
                .subSoil(SubSoilRequirements.gold)
                .seedTexture("oreberry").seedColor(Materials.Gold.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("bauxia_leaf").displayName("铝土叶").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(DrMetaItems.BAUXIA_LEAF.getStackForm())
                .subSoil(SubSoilRequirements.aluminium)
                .seedTexture("oreberry").seedColor(Materials.Aluminium.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("coppon_fiber").displayName("铜纤维草").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(DrMetaItems.COPPON_FIBER.getStackForm())
                .subSoil(SubSoilRequirements.copper)
                .seedTexture("oreberry").seedColor(Materials.Copper.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("ferrofern_leaf").displayName("铁蕨叶").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
        ...
        register(new CropType.Builder("micadia_flower").displayName("云母花").tier(5).soil(SoilTypes.sand)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(DrMetaItems.MICADIA_FLOWER.getStackForm())
                .seedTexture("oreberry").seedColor(Materials.Mica.getMaterialRGB())
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("plumbilia_leaf").displayName("铅叶草").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
        ...
        register(new CropType.Builder("salty_root").displayName("盐根").tier(5).soil(SoilTypes.sand)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(28)
                .addDrop(DrMetaItems.SALTY_ROOT.getStackForm())
                .seedTexture("oreberry").seedColor(Materials.Salt.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("tine_twig").displayName("锡枝").tier(5).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(DrMetaItems.TINE_TWIG.getStackForm())
                .subSoil(SubSoilRequirements.tin)
        ...
        //  Tier 6
        // ================================================================
        register(new CropType.Builder("redwheat").displayName("红石小麦").tier(6).soil(SoilTypes.farmland)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(32)
                .addDrop(new ItemStack(Items.REDSTONE, 2))
                .lightRequirementLess(7f)
                .subSoil(SubSoilRequirements.redstone)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("brown_mushroom").displayName("棕蘑菇").tier(6).soil(SoilTypes.mushroom)
        ...
        register(new CropType.Builder("red_mushroom").displayName("红蘑菇").tier(6).soil(SoilTypes.mushroom)
                .maxGrowthStage(4).harvestStage(4).stageRequirement(30)
                .addDrop(new ItemStack(Blocks.RED_MUSHROOM, 2))
                .lightRequirementLess(1).renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("blazeflower").displayName("烈焰花").tier(6).soil(SoilTypes.netherrack)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
                .addDrop(new ItemStack(Items.BLAZE_POWDER, 2))
                .subSoil(SubSoilRequirements.magma)
                .lightRequirement(12).renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("enderflower").displayName("末影花").tier(6).soil(SoilTypes.end)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
                .addDrop(new ItemStack(Items.ENDER_PEARL))
                .subSoil(SubSoilRequirements.compressed26)
                .lightRequirementLess(1).renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("explosivegrass").displayName("爆炸草").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(30)
                .addDrop(new ItemStack(Items.GUNPOWDER, 3))
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("demon_claw").displayName("恶魔爪").tier(6).soil(SoilTypes.netherrack)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
                .addDrop(new ItemStack(Items.QUARTZ, 3))
                .subSoil(SubSoilRequirements.quartz)
                .lightRequirementLess(1).renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("whale_claw").displayName("云鲸爪").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
                ...
                .subSoil(SubSoilRequirements.certusQuartz)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("tin_leaf").displayName("锡叶子").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
        ...
        register(new CropType.Builder("copper_leaf").displayName("铜叶子").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
        ...
        register(new CropType.Builder("titanium_leaf").displayName("钛叶子").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(34)
                .addDrop(Materials.Titanium.getItemForm(OrePrefix.nugget, 2))
                .subSoil(SubSoilRequirements.titanium)
                .seedTexture("oreberry").seedColor(Materials.Titanium.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        // --- MetaCrops Tier 6 ---
        register(new CropType.Builder("galvania_leaf").displayName("电镀叶").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
                .addDrop(DrMetaItems.GALVANIA_LEAF.getStackForm())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("nickelback_leaf").displayName("镍叶草").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
                .addDrop(DrMetaItems.NICKELBACK_LEAF.getStackForm())
                .subSoil(SubSoilRequirements.nickel)
                .seedTexture("oreberry").seedColor(Materials.Nickel.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("scheelinium_leaf").displayName("钨叶草").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(34)
                .addDrop(DrMetaItems.SCHEELINIUM_LEAF.getStackForm())
                .subSoil(SubSoilRequirements.tungsten)
                .seedTexture("oreberry").seedColor(Materials.Tungsten.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("thiosulfine_flower").displayName("硫磺花").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(32)
                .addDrop(DrMetaItems.THIOSULFINE_FLOWER.getStackForm())
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("titania_leaf").displayName("钛叶草").tier(6).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(34)
        ...
        //  Tier 7
        // ================================================================
        register(new CropType.Builder("aurelia").displayName("金叶草").tier(7).soil(SoilTypes.stone)
        ...
        register(new CropType.Builder("tearflower").displayName("哭泣花").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(36)
                .addDrop(new ItemStack(Items.GHAST_TEAR))
                .lightRequirement(0).renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("prismaleaf").displayName("晶化叶").tier(7).soil(SoilTypes.water)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(36)
        ...
        register(new CropType.Builder("silver_leaf").displayName("银叶子").tier(7).soil(SoilTypes.stone)
        ...
        register(new CropType.Builder("aluminum_leaf").displayName("铝叶子").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(36)
        ...
        register(new CropType.Builder("zinc_leaf").displayName("锌叶子").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(36)
                .addDrop(Materials.Zinc.getItemForm(OrePrefix.nugget, 2))
                .subSoil(SubSoilRequirements.zinc)
                .seedTexture("oreberry").seedColor(Materials.Zinc.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("nickel_leaf").displayName("镍叶子").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(36)
        ...
        // --- MetaCrops Tier 7 ---
        register(new CropType.Builder("iridine_flower").displayName("铱花").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(36)
                .addDrop(DrMetaItems.IRIDINE_FLOWER.getStackForm())
                .seedTexture("oreberry").seedColor(0xE0E0FF)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("osmianth_flower").displayName("锇花").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(36)
                .addDrop(DrMetaItems.OSMIANTH_FLOWER.getStackForm())
                .seedTexture("oreberry").seedColor(0x6060A0)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("platina_leaf").displayName("铂叶草").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(5).harvestStage(5).stageRequirement(36)
                .addDrop(DrMetaItems.PLATINA_LEAF.getStackForm())
                .subSoil(SubSoilRequirements.platinum)
                .seedTexture("oreberry").seedColor(Materials.Platinum.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("stargatium_leaf").displayName("星门叶").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(36)
                .addDrop(DrMetaItems.STARGATIUM_LEAF.getStackForm())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("thunder_flower").displayName("雷霆花").tier(7).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(36)
        ...
        //  Tier 8
        // ================================================================
        register(new CropType.Builder("dahlia").displayName("大丽金刚").tier(8).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
                .addDrop(new ItemStack(Items.DIAMOND))
                .subSoil(SubSoilRequirements.diamond).lightRequirement(12)
                .seedTexture("oreberry").seedColor(Materials.Diamond.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("black_lotus").displayName("黑莲花").tier(8).soil(SoilTypes.mushroom)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("thunder_grass").displayName("雷鸣草").tier(8).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
                .addDrop(Materials.Thulium.getItemForm(OrePrefix.nugget, 2))
                .subSoil(SubSoilRequirements.thulium)
                .seedTexture("oreberry").seedColor(Materials.Thulium.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("manganese_leaf").displayName("锰叶子").tier(8).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
                .addDrop(Materials.Manganese.getItemForm(OrePrefix.nugget, 2))
                .subSoil(SubSoilRequirements.manganese)
                .seedTexture("oreberry").seedColor(Materials.Manganese.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        // --- MetaCrops Tier 8 ---
        register(new CropType.Builder("bobs_yer_uncle_berry").displayName("鲍勃叔叔浆果").tier(8).soil(SoilTypes.mushroom)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
                .addDrop(DrMetaItems.BOBS_YER_UNCLE_BERRY.getStackForm())
                .seedTexture("oreberry").seedColor(0xFF4488)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("magic_essence").displayName("魔法精华").tier(8).soil(SoilTypes.mushroom)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("pyrolusium_leaf.0").displayName("软锰矿叶").tier(8).soil(SoilTypes.stone).texturePath("pyrolusium")
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("pyrolusium_leaf.1").displayName("软锰矿叶I").tier(8).soil(SoilTypes.stone).texturePath("pyrolusium")
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("pyrolusium_leaf.2").displayName("软锰矿叶II").tier(8).soil(SoilTypes.stone).texturePath("pyrolusium")
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("pyrolusium_leaf.3").displayName("软锰矿叶III").tier(8).soil(SoilTypes.stone).texturePath("pyrolusium")
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("pyrolusium_leaf.banana").displayName("香蕉软锰矿叶").tier(8).soil(SoilTypes.stone).texturePath("pyrolusium")
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("pyrolusium_leaf.canada").displayName("加拿大软锰矿叶").tier(8).soil(SoilTypes.stone).texturePath("pyrolusium")
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("pyrolusium_leaf.no_egg").displayName("无蛋软锰矿叶").tier(8).soil(SoilTypes.stone).texturePath("pyrolusium")
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        register(new CropType.Builder("reactoria_leaf").displayName("反应堆叶").tier(8).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
                .addDrop(DrMetaItems.REACTORIA_LEAF.getStackForm())
                .subSoil(SubSoilRequirements.uranium)
                .seedTexture("oreberry").seedColor(Materials.Uranium238.getMaterialRGB())
                .lightRequirement(0)
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("reactoria_stem").displayName("反应堆茎").tier(8).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(40)
        ...
        //  Tier 9
        // ================================================================
        register(new CropType.Builder("green_diamond").displayName("绿金刚").tier(9).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(45)
                .addDrop(new ItemStack(Items.EMERALD))
                .subSoil(SubSoilRequirements.emerald).lightRequirement(12)
                .seedTexture("oreberry").seedColor(Materials.Emerald.getMaterialRGB())
                .renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("lucky_clover").displayName("幸运草").tier(9).soil(SoilTypes.dirtGrass)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(44)
                .addDrop(DrMetaItems.LUCKY_CLOVER.getStackForm(3))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("wither_flower").displayName("凋零花").tier(9).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(65)
                .addDrop(new ItemStack(Items.SKULL, 1, 1))
                .subSoil(SubSoilRequirements.compressed100Meta2)
                .lightRequirement(0).renderType(CropRenderType.CROSS).build());

        // --- MetaCrops Tier 9 ---
        register(new CropType.Builder("space_flower").displayName("太空花").tier(9).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(45)
                .addDrop(DrMetaItems.SPACE_FLOWER.getStackForm())
                .seedTexture("flower").seedColor(0xFF44FF)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("uua_berry").displayName("UUA浆果").tier(9).soil(SoilTypes.stone)
                .maxGrowthStage(6).harvestStage(6).stageRequirement(45)
        ...
        //  Tier 10
        // ================================================================
        register(new CropType.Builder("starwart").displayName("星之疣").tier(10).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(80)
                .addDrop(new ItemStack(Items.NETHER_STAR))
                .subSoil(SubSoilRequirements.compressed100Meta2)
                .lightRequirement(0).renderType(CropRenderType.HASH).build());

        register(new CropType.Builder("nuclear_grass").displayName("核能草").tier(10).soil(SoilTypes.stone)
        ...
        register(new CropType.Builder("bedrock_heart").displayName("基岩之心").tier(10).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(52)
                .addDrop(CraftingRecipes.getItemStack("<enderio:item_material:20>"))
                .subSoil(SubSoilRequirements.bedrock)
                .renderType(CropRenderType.HASH).build());

        // --- MetaCrops Tier 10 ---
        register(new CropType.Builder("star_wart").displayName("星之疣").tier(10).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(50)
        ...
        register(new CropType.Builder("uum_berry").displayName("UUM浆果").tier(10).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(50)
        ...
        //  Tier 11
        // ================================================================
        register(new CropType.Builder("space_berry").displayName("空间莓").tier(11).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(55)
                .addChanceDrop(MetaItems.UU_MATER.getStackForm(), 0.05f)
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("platinum_leaf").displayName("铂叶子").tier(11).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(55)
        ...
        register(new CropType.Builder("tungsten_leaf").displayName("钨叶子").tier(11).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(55)
        ...
        register(new CropType.Builder("money_grass").displayName("多金草").tier(11).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(55)
                .addDrop(new ItemStack(Blocks.GOLD_BLOCK, 4))
                .renderType(CropRenderType.CROSS).build());

        register(new CropType.Builder("mech_brain").displayName("机械脑").tier(11).soil(SoilTypes.stone)
                .maxGrowthStage(7).harvestStage(7).stageRequirement(200)
                .subSoil(SubSoilRequirements.mechBrain)
        ...
        register(new CropType.Builder("heartfruit").displayName("心鸣果").tier(11).soil(SoilTypes.dirtGrass)
