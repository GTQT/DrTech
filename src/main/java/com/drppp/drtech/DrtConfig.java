...
public class DrtConfig {
    ...
    public static HordeSwitch HordeSwitch = new HordeSwitch();
    public static EnvironmentSwitch EnvironmentSwitch = new EnvironmentSwitch();

    public static class EnvironmentSwitch {
        @Config.LangKey("enable_air_pollution")
        @Config.Comment("开启空气污染")
        @Config.RequiresMcRestart
        public static boolean EnableAirPollution = true;
    }
    ...
    public static class HordeSwitch {
