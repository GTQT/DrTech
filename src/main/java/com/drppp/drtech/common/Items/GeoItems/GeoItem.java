package com.drppp.drtech.common.Items.GeoItems;
...
public class GeoItem extends Item implements IAnimatable {
    public AnimationFactory factory = new AnimationFactory(this);
    private String controllerName = "getItemController";
    ...
    public void registerControllers(AnimationData data) {
        AnimationController<GeoItem> controller = new AnimationController<GeoItem>(this,
