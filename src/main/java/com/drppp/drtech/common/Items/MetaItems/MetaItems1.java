...
public  class MetaItems1 extends StandardMetaItem {
    ...
    public void registerSubItems() {
        DrMetaItems.ENERGY_ELEMENT_1 = this.addItem(0,"energy_element_1").setMaxStackSize(64).setCreativeTabs(DrTechMain.Mytab)
                .addComponents(new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.weight.tooltip.1", new Object[0]));
                })
                );
        DrMetaItems.ENERGY_ELEMENT_2 = this.addItem(1,"energy_element_2").setMaxStackSize(64).setCreativeTabs(DrTechMain.Mytab)
                .addComponents(new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.weight.tooltip.2", new Object[0]));
                }));
        DrMetaItems.ENERGY_ELEMENT_3 = this.addItem(2,"energy_element_3").setMaxStackSize(64).setCreativeTabs(DrTechMain.Mytab)
                .addComponents(new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.weight.tooltip.3", new Object[0]));
                }));
        DrMetaItems.ENERGY_ELEMENT_4 = this.addItem(3,"energy_element_4").setMaxStackSize(64).setCreativeTabs(DrTechMain.Mytab)
                .addComponents(new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.weight.tooltip.4", new Object[0]));
                }));
        DrMetaItems.ENERGY_ELEMENT_5 = this.addItem(4,"energy_element_5").setMaxStackSize(64).setCreativeTabs(DrTechMain.Mytab)
                .addComponents(new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.weight.tooltip.5", new Object[0]));
                }));
        DrMetaItems.GRAVITY_SHIELD = this.addItem(5,"gravity_shield").setMaxStackSize(1).setCreativeTabs(DrTechMain.Mytab)
                .addComponents(new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.gravity_shield.tooltip.1", new Object[0]));
                })).addComponents(new ChunkRemoveBehavior());
                DrMetaItems.SKULL_DUST = this.addItem(6,"skull_dust").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64);
                DrMetaItems.PIPIE_1 = this.addItem(10,"pipe_1").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64)
                        .addComponents(new TooltipBehavior((lines) -> {
                            lines.add(I18n.format("metaitem.pipe_1.tooltip.1", new Object[0]));
                        }));
                DrMetaItems.PIPIE_5 = this.addItem(11,"pipe_5").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64)
                        .addComponents(new TooltipBehavior((lines) -> {
                            lines.add(I18n.format("metaitem.pipe_5.tooltip.1", new Object[0]));
                        }));
                DrMetaItems.PIPIE_10 = this.addItem(12,"pipe_10").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64)
                        .addComponents(new TooltipBehavior((lines) -> {
                            lines.add(I18n.format("metaitem.pipe_10.tooltip.1", new Object[0]));
                        }));
        DrMetaItems.POS_CARD = this.addItem(13,"pos_card").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(1).addComponents(new DataItemBehavior(true));
        DrMetaItems.GOLD_COIN = this.addItem(14,"gold_coin").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
        ...
        DrMetaItems.GRASS_KILLER = this.addItem(27,"grass_killer")
                ...
                .setCreativeTabs(DrTechMain.Mytab)
                .setMaxStackSize(1);
        DrMetaItems.UPGRADE_NULL = this.addItem(28,"upgrade_null").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64);
        DrMetaItems.UPGRADE_SPEED1 = this.addItem(29,"upgrade_speed1").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_SPEED2 = this.addItem(30,"upgrade_speed2").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
        ...
        DrMetaItems.UPGRADE_SPEED3 = this.addItem(31,"upgrade_speed3").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
        ...
        DrMetaItems.UPGRADE_SPEED4 = this.addItem(32,"upgrade_speed4").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
        ...
        DrMetaItems.UPGRADE_SPEED5 = this.addItem(33,"upgrade_speed5").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
        ...
        DrMetaItems.UPGRADE_SPEED6  = this.addItem(34,"upgrade_speed6").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
        ...
        DrMetaItems.UPGRADE_SPEED7  = this.addItem(35,"upgrade_speed7").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
        ...
        DrMetaItems.UPGRADE_SPEED8  = this.addItem(36,"upgrade_speed8").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
        ...
        DrMetaItems.UPGRADE_SPEED8P  = this.addItem(37,"upgrade_speed8p").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","加速"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
                    lines.add(I18n.format("metaitem.upgrade.speed","256"));
        ...
        DrMetaItems.UPGRADE_PRODUCTION  = this.addItem(38,"upgrade_production").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_PLAIN  = this.addItem(39,"upgrade_plain").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_LIGHT  = this.addItem(40,"upgrade_light").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_FLOWERING  = this.addItem(41,"upgrade_flowering").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_WINTER_EMULATION  = this.addItem(42,"upgrade_winter_emulation").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_DRYER  = this.addItem(43,"upgrade_dryer").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_AUTOMATION  = this.addItem(44,"upgrade_automation").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","自动化"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
                    lines.add(I18n.format("metaitem.upgrade.energy","+10%"));
                }));
        DrMetaItems.UPGRADE_HUMIDIFIER  = this.addItem(45,"upgrade_humidifier").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","干燥"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","16"));
        ...
        DrMetaItems.UPGRADE_HELL_EMULATION  = this.addItem(46,"upgrade_hell_emulation").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_POLLEN_SCRUBBER  = this.addItem(47,"upgrade_pollen_scrubber").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_DESERT_EMULATION  = this.addItem(48,"upgrade_desert_emulation").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_COOLER  = this.addItem(49,"upgrade_cooler").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_LIFESPAN  = this.addItem(50,"upgrade_lifespan").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_SEAL  = this.addItem(51,"upgrade_seal").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_GENETIC_STABILIZER  = this.addItem(52,"upgrade_genetic_stabilizer").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_JUNGLE_EMULATION  = this.addItem(53,"upgrade_jungle_emulation").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_TERRITORY  = this.addItem(54,"upgrade_territory").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_OCEAN_EMULATION  = this.addItem(55,"upgrade_ocean_emulation").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_OPEN_SKY  = this.addItem(56,"upgrade_open_sky").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","露天环境"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
                    lines.add(I18n.format("metaitem.upgrade.energy","+5%"));
                }));
        DrMetaItems.UPGRADE_HEATER  = this.addItem(57,"upgrade_heater").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_SIEVE  = this.addItem(58,"upgrade_sieve").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
        ...
        DrMetaItems.UPGRADE_T  = this.addItem(59,"upgrade_t").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64).addComponents(
                new TooltipBehavior((lines) -> {
                    lines.add(I18n.format("metaitem.upgrade.info","黑夜环境"));
                    lines.add(I18n.format("metaitem.upgrade.maxnum","1"));
                    lines.add(I18n.format("metaitem.upgrade.energy","+5%"));
                }));
        DrMetaItems.TOOL_BOX = this.addItem(60,"tool_box").setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(1)
                .addComponents(
                        new TooltipBehavior((lines) -> {
                            lines.add(I18n.format("metaitem.upgrade.tool_box.1"));
                            lines.add(I18n.format("metaitem.upgrade.tool_box.2"));
                        }));
        DrMetaItems.MATRIX_GEMS = this.addItem(61,"matrix_gem").addComponents(new MatrixGemsBehavior()).setCreativeTabs(DrTechMain.Mytab).setMaxStackSize(64);
    }
