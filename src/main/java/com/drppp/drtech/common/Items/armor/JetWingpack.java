...
import com.drppp.drtech.Client.audio.MovingSoundJetEngine;
import com.drppp.drtech.Client.render.JetWingpackModel;
import com.drppp.drtech.api.Utils.ElytraFlyingUtils;
import com.drppp.drtech.api.capability.IElytraFlyingProvider;
...
public class JetWingpack extends ArmorLogicSuite implements IItemHUDProvider {
    ...
    protected static final Function<FluidStack, Integer> FUEL_BURN_TIME = fluidStack -> {
        Recipe recipe = DrtechReceipes.JET_WINGPACK_FUELS.findRecipe(
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (engineActive && player.isElytraFlying()) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return "gregtech:textures/armor/jet_wingpack.png";
    }
    ...
    private static class ElytraFlyingProvider implements IItemComponent, IElytraFlyingProvider, ICapabilityProvider, IItemCapabilityProvider {
        ...
        public boolean hasCapability(@NotNull Capability<?> capability, @Nullable EnumFacing facing) {
            return capability == DrtCapabilities.ELYTRA_FLYING_PROVIDER;
        }

        @Nullable
        @Override
        public <T> T getCapability(@NotNull Capability<T> capability, @Nullable EnumFacing facing) {
            return capability == DrtCapabilities.ELYTRA_FLYING_PROVIDER ? DrtCapabilities.ELYTRA_FLYING_PROVIDER.cast(this) : null;
        }
    ...
    public class JetWingpackBehaviour implements IItemDurabilityManager, IItemCapabilityProvider, IItemBehaviour, ISubItemHandler {
        ...
        public void getSubItems(ItemStack itemStack, CreativeTabs creativeTab, NonNullList<ItemStack> subItems) {
            ...
            if (fluidHandlerItem != null) {
                Optional<Recipe> firstRecipe = DrtechReceipes.JET_WINGPACK_FUELS.getRecipeList().stream().findFirst();
