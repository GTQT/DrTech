package com.drppp.drtech.common.MetaTileEntities.Logic;

import com.drppp.drtech.common.MetaTileEntities.muti.electric.standard.MetaTileEntityInfiniteFluidDrill;
...
public class MyFluidDrillLogic {
    ...
    private final MetaTileEntityInfiniteFluidDrill metaTileEntity;
    ...
    public MyFluidDrillLogic(MetaTileEntityInfiniteFluidDrill metaTileEntity) {
    ...
    public void performDrilling() {
        ...
        if (metaTileEntity.fillTanks(new FluidStack(veinFluid, amount*2), true)) {
            metaTileEntity.fillTanks(new FluidStack(veinFluid, amount*2), false);
            //depleteVein();
        } else {
