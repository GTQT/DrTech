...
public class MetaTileEntityIndustrialCablePress extends RecipeMapMultiblockController {
    ...
    private static final StructureDefinition<?> STRUCTURE_DEFINITION =
            StructureDefinition.getOrBuild("drtech:industrial_cable_press",
    ...
    private static StructureDefinition<?> buildTemplate() {
        return DeclarativePatternBuilder.start(RIGHT, UP, BACK)
                ...
                .aisle("XXX", "X X", "XXX")
                .aisle("XXX", "XSX", "XXX")
                .self('S', MetaTileEntityIndustrialCablePress.class)
                .where('X', Elements.chain(
                        Elements.counted(14, 4096, Elements.block(getCasingState())),
