...
public class FusionCasingStats {
    ...
    public static FusionCasingStats of(BlockFusionReactorCasing.CasingType type) {
        switch (type) {
            ...
            case COOLING_CHANNEL_1: return coolant(1);
            ...
            case SUPERCONDUCTING_MAGNET_1: return magnet(1);
            ...
            case SUPERCONDUCTING_MAGNET_5: return magnet(5);
            default:
                throw new IllegalArgumentException("Not a tiered fusion casing: " + type.getName());
        }
    }

    /** 根据方块枚举变种构造对应模块/档位的统计（外壳二：中子捕获/氚增殖，整族 1~5 档） */
    @Nonnull
    public static FusionCasingStats of(BlockFusionReactorCasing2.CasingType type) {
        switch (type) {
            case NEUTRON_CAPTURE_1: return neutronCapture(1);
            ...
            case TRITIUM_BREEDING_BLANKET_1: return tritiumBreeding(1);
