...
public class TacticalLaserSubmachineGunBehavior implements IItemBehaviour {
    private static final long RANGED_COST = 1000L;
    private static final long MELEE_COST = 100L;
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
        ...
        if (!player.world.isRemote && WeaponBehaviorUtil.drainEnergy(stack, MELEE_COST)) {
            ...
            target.attackEntityFrom(DamageSource.causePlayerDamage(player), 25.0f);
        }
        return true;
    }
}
