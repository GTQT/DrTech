...
public class MTMetaItem extends StandardMetaItem {
    ...
    public void registerSubItems() {
        ...
        APIARIST_SHIELD  = addItem(11, "apiarist_shield");
        REVEALING_GOGGLES = addItem(12, "revealing_goggles");
        VIS_OPTIMIZER     = addItem(13, "vis_optimizer");
        // Armor Platings
        ...
        // 全部模块/护甲板的 MetaValueItem 就绪后，把每个 IModule 作为物品行为挂上（原 MechTech 生命周期缺失的调用）
        Modules.init();
    }
