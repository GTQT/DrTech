...
/**
 * 聚变堆外壳（一）：第一壁、冷却剂回路、超导磁体，整族 1~5 档。
...
public class BlockFusionReactorCasing extends VariantBlock<BlockFusionReactorCasing.CasingType> {
    ...
    public BlockFusionReactorCasing() {
        ...
        setDefaultState(getState(CasingType.FIRST_WALL_1));
    ...
    public enum CasingType implements IStringSerializable {
        ...
        SUPERCONDUCTING_MAGNET_1("superconducting_magnet_1"),
        ...
        SUPERCONDUCTING_MAGNET_5("superconducting_magnet_5");
