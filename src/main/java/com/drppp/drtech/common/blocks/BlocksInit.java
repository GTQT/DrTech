...
public class BlocksInit {
    ...
    public static final BlockFusionReactorTieredCasing FUSION_REACTOR_TIERED_CASING = new BlockFusionReactorTieredCasing();
    public static final BlockFusionReactorTieredCasing2 FUSION_REACTOR_TIERED_CASING2 = new BlockFusionReactorTieredCasing2();
    ...
    public static void init(RegistryEvent.Register<Block> event) {
        ...
        event.getRegistry().register(FUSION_REACTOR_TIERED_CASING);
        event.getRegistry().register(FUSION_REACTOR_TIERED_CASING2);
