...
import static com.drppp.drtech.loaders.recipes.DrtechRecipes.*;
...
*/
        ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(CraftingRecipes.getItemStack("item('gregtech:meta_item_1', 717)"))
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(CraftingRecipes.getItemStack("item('gregtech:meta_item_1', 718)"))
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(CraftingRecipes.getItemStack("item('gregtech:meta_item_1', 719)"))
