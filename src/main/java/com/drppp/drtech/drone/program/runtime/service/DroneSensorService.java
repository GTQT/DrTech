...
public interface DroneSensorService {
    ...
    default int countEntities(DroneArea area, @Nullable DroneEntityFilterSpec filter, int limit) { return 0; }
    default DroneEntitySensorResult senseNearestEntity(DroneArea area, @Nullable DroneEntityFilterSpec filter) { return DroneEntitySensorResult.EMPTY; }
    default DroneEntitySensorResult senseEntity(DroneArea area,
            @Nullable DroneEntityFilterSpec filter,
