...
import com.drppp.drtech.drone.energy.DroneEnergyCosts;
import com.drppp.drtech.drone.api.DroneEntityTransportEvent;
import com.drppp.drtech.drone.api.DroneExtensionRegistry;
import com.drppp.drtech.drone.api.DroneSignEditEvent;
import com.drppp.drtech.drone.action.*;
...
import com.drppp.drtech.drone.energy.DroneEnergyStorage;
import com.drppp.drtech.drone.energy.DroneEuEndpoint;
import com.drppp.drtech.drone.energy.DroneEuTransfer;
import com.drppp.drtech.drone.firmware.DroneSafetyFirmware;
import com.drppp.drtech.drone.firmware.DroneSafetyState;
import com.drppp.drtech.drone.item.DroneItemData;
...
import com.drppp.drtech.drone.compat.ThaumcraftEssentiaNodeCompat;
import com.drppp.drtech.drone.inventory.DroneItemFilter;
import com.drppp.drtech.drone.inventory.DroneAutoPickupMode;
import com.drppp.drtech.drone.inventory.DroneCargoFullPolicy;
import com.drppp.drtech.drone.filter.DroneItemFilterSpec;
import com.drppp.drtech.drone.inventory.DroneCraftingPlanner;
import com.drppp.drtech.drone.inventory.DroneItemTransfer;
...
import com.drppp.drtech.drone.navigation.DronePathResult;
import com.drppp.drtech.drone.navigation.DronePathfinder;
import com.drppp.drtech.drone.navigation.MinecraftDroneNavigationWorld;
import com.drppp.drtech.drone.network.DroneDockNetwork;
import com.drppp.drtech.drone.network.DroneDockRecord;
...
import com.drppp.drtech.drone.network.DroneReservation;
import com.drppp.drtech.drone.sound.DroneSoundCue;
import com.drppp.drtech.drone.sound.DroneSoundPlayer;
import com.drppp.drtech.drone.visual.DroneVisualState;
import com.drppp.drtech.drone.navigation.DronePathStatus;
import com.drppp.drtech.drone.program.codec.DroneProgramFormatException;
import com.drppp.drtech.drone.program.codec.DroneProgramNbtCodec;
import com.drppp.drtech.drone.program.codec.DroneProgramMigrator;
...
import com.drppp.drtech.drone.program.runtime.DroneActionState;
import com.drppp.drtech.drone.program.runtime.DroneActionStatus;
import com.drppp.drtech.drone.program.runtime.DroneExecutionResult;
import com.drppp.drtech.drone.program.runtime.DroneProgramRuntime;
import com.drppp.drtech.drone.program.runtime.DroneRuntimeEnvironment;
    ...
    private DroneRuntimeEnvironment createRuntimeEnvironment() {
        return new DroneRuntimeEnvironment() {
            ...
            private DroneExecutionResult attackEntityInternal(BlockPos target, DroneEntityFilterSpec filter,
                ...
                if (entity instanceof EntityPlayer && !DrtConfig.drone.EnableDronePlayerAttack) {
                    return DroneExecutionResult.failure(DroneActionStatus.DENIED, "failed",
                ...
                if (DrtConfig.drone.EnableDroneCombat) return DroneExecutionResult.failure(
            ...
            private boolean isAttackablePatrolCandidate(EntityLivingBase entity) {
                ...
                return !(entity instanceof EntityPlayer) || DrtConfig.drone.EnableDronePlayerAttack;
            }
            ...
            private DroneExecutionResult transferItems(BlockPos target, DroneItemFilter filter, boolean importing) {
                DroneTransferRequest legacy = DroneTransferRequest.at(target, null,
                        ...
                        DroneFailurePolicy.ERROR, filter.getSpec());
            ...
            private TransferTargetSelection selectAreaTransferTarget(DroneTransferRequest request,
                ...
                if (request.getSearchMode() == DroneSearchMode.NEAREST) {
                    BlockPos current = new BlockPos(posX, posY, posZ);
                    candidates.sort(Comparator.comparingDouble(position -> position.distanceSq(current)));
                } else if (request.getSearchMode() == DroneSearchMode.RANDOM) {
