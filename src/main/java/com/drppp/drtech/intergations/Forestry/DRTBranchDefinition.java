...
public enum DRTBranchDefinition {

    DRT_ORGANIC("Fuelisd", alleles -> {
    ...
    DRT_INDUSTRIAL("Industrialisd", alleles -> {
    ...
    DRT_METAL("Metaliferisd", alleles -> {
    ...
    DRT_RAREMETAL("Mineralisd", alleles -> {
    ...
    DRTBranchDefinition(String scientific, Consumer<IAllele[]> branchProperties) {
