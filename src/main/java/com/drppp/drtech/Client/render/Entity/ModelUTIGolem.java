...
public class ModelUTIGolem extends ModelBase
{
    ...
    public ModelUTIGolem()
    {
        this(0.0F);
    }

    public ModelUTIGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelUTIGolem(float p_i46362_1_, float p_i46362_2_)
    {
        int i = 128;
        int j = 128;
    ...
    {
        EntityUTiGolem entityirongolem = (EntityUTiGolem)entitylivingbaseIn;
