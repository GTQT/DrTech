...
public class SoundManager {
    ...
    public static SoundEvent JET_ENGINE_LOOP=  new SoundEvent(new ResourceLocation(Tags.MODID, "item.jet_wingpack_engine_active"));
    //laser_bullet_shoot
    @SubscribeEvent
    public static void onSoundEvenrRegistration(RegistryEvent.Register<SoundEvent> event)
    {
        ...
        event.getRegistry().register(JET_ENGINE_LOOP.setRegistryName("item.jet_wingpack_engine_active"));
    }
