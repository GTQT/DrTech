...
public class BlockBubbleColumn extends Block {
    ...
    public BlockBubbleColumn() {
        ...
        setRegistryName(FutureMCMain.MODID, "bubble_column");
        setTranslationKey(FutureMCMain.MODID + ".bubble_column");
    ...
    private static IBlockState getBubbleState(boolean dragDown) {
        return FutureMCMain.BUBBLE_COLUMN.getDefaultState().withProperty(DRAG_DOWN, dragDown);
    }
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, DRAG_DOWN);
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(DRAG_DOWN, meta == 1);
    }
