package com.drppp.futuremc.entity;
...
public class EntityHappyGhast extends EntityGhast {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand) {
        ...
        if (!this.getHarnessed() && stack.getItem() == FutureMCMain.HAPPY_GHAST_HARNESS) {
            if (!this.world.isRemote) {
        ...
        if (this.getHarnessed() && stack.getItem() == Items.SHEARS) {
            if (!this.world.isRemote) {
                ...
                this.updateHome();
            this.entityDropItem(new ItemStack(FutureMCMain.HAPPY_GHAST_HARNESS), 0.0F);
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (!this.world.isRemote && this.getHarnessed()) {
            this.dropItem(FutureMCMain.HAPPY_GHAST_HARNESS, 1);
        }
    }
    ...
    public String getName() {
        ...
        return I18n.translateToLocal(this.isChildForm() ? "entity.futuremc.ghastling.name" : "entity.futuremc.happy_ghast.name");
    }
    ...
    static class AIFollowTemptingPlayer extends EntityAIBase {
        ...
        return player.getHeldItemMainhand().getItem() == FutureMCMain.HAPPY_GHAST_HARNESS
                || player.getHeldItemOffhand().getItem() == FutureMCMain.HAPPY_GHAST_HARNESS;
        }
    }
